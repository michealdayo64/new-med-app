    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            if id:
                ...
                app_id = Appointment.objects.create(user=user, ailment_id=ailment_id, phone_no=phone_no,
                ...
                app_id = Appointment.objects.create(
                    user=user, phone_no=phone_no, message=message, date=date_format, appointment_time=time, is_booked=False)
                payload["response"] = "Appointment Order"
                payload['app_id'] = app_id.id
                payload['firstname'] = app_id.user.first_name
                payload['lastname'] = app_id.user.last_name
